...
# Updated Code with Language Support and Admin-Only Language Setting
    ...
    buttons = [
        [
            InlineKeyboardButton(
                LANGUAGES[lang]["buttons"]["handled"], callback_data="handled"),
            InlineKeyboardButton(
                LANGUAGES[lang]["buttons"]["investigating"], callback_data="investigating"),
            InlineKeyboardButton(
                LANGUAGES[lang]["buttons"]["ignored"], callback_data="ignored")
        ]
    ]
    markup = InlineKeyboardMarkup(buttons)
    await update.message.reply_html(reply_msg, reply_markup=markup)
